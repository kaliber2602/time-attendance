  ...
  return (
    <div className="min-vh-100 d-flex" style={{ background: "linear-gradient(90deg, #4e54c8 0%, #8f94fb 100%)" }}>
      ...
      <div className="bg-dark text-white p-4 d-flex flex-column" style={{ width: 220, minHeight: "100vh" }}>
        <div className="mb-4 fw-bold fs-4 text-center">Quản lý phòng ban</div>
        ...
        <button className="btn btn-outline-light mb-2 text-start" onClick={() => navigate("/tasks")}>
          Quản lý công việc
        </button>
        <button className="btn btn-outline-light mb-2 text-start" onClick={() => navigate("/requests")}>
          Duyệt yêu cầu
        </button>
        <button className="btn btn-outline-light mb-2 text-start" onClick={() => navigate("/summary")}>
          Xem thống kê công
        </button>
        <button className="btn btn-outline-light mb-2 text-start" onClick={() => navigate("/employees")}>
          Quản lý nhân viên
        </button>
      ...
      {/* Main content */}
      <div className="flex-grow-1 p-5" style={{ maxHeight: "100vh", overflowY: "auto" }}>
        {/* Welcome message */}
